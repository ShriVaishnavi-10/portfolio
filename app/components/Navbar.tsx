...
export default function Navbar() {
    return (
        <nav className="fixed top-8 left-0 right-0 z-[100] flex justify-center pointer-events-none">
            ...
            >
                <div className="hidden md:block font-playfair text-[11px] font-medium tracking-[0.4em] text-[#D4AF37] uppercase">
                    Shri Vaishnavi
                </div>

                <div className="hidden md:block h-4 w-[1px] bg-foreground/10" />

                <div className="flex gap-4 md:gap-8 text-[8px] md:text-[9px] uppercase tracking-[0.2em] md:tracking-[0.3em] font-medium text-[#D4AF37] font-jakarta">
                    <a href="#work" className="hover:text-foreground transition-colors duration-500">Works</a>
